...
<aside class="fixed inset-y-0 left-0 z-50 w-64 bg-slate-900 text-white transform transition-transform duration-200 lg:translate-x-0"
    ...
    <nav class="px-3 py-4 overflow-y-auto" style="height:calc(100vh - 4rem)">
        <div class="space-y-0.5 mb-6">
            @php $nav=[['crm.dashboard','Dashboard','📊'],['crm.contacts.index','Contacts','👥'],['crm.leads.index','Sales Pipeline','💼'],['crm.campaigns.index','Campaigns','📣'],['crm.loyalty.index','Loyalty Points','🌟'],['crm.tickets.index','Support','🎫'],['crm.tally.index','Tally Import','📁'],['crm.analytics','Analytics','📈']]; @endphp
