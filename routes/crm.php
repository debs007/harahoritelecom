...
Route::prefix('crm')->name('crm.')->group(function () {
    ...
    Route::middleware('crm_auth')->group(function () {
        ...
        Route::prefix('contacts')->name('contacts.')->group(function () {
            ...
            Route::get('/export-pdf',                 [CrmContactController::class, 'exportPdf'])->name('export-pdf');
        ...
        Route::prefix('settings')->name('settings.')->group(function () {
            ...
            Route::post('/',         [CrmSettingsController::class, 'update'])->name('update');
            Route::post('/reclassify',[CrmSettingsController::class,'reclassify'])->name('reclassify');
        });
        ...
        Route::prefix('campaigns')->name('campaigns.')->group(function () {
            ...
            Route::post('/test-connection',        [CrmCampaignController::class, 'testConnection'])->name('test');
        });

        // Loyalty Points
        Route::prefix('loyalty')->name('loyalty.')->group(function () {
            Route::get('/',                            [CrmLoyaltyController::class, 'index'])->name('index');
            Route::post('/settings',                   [CrmLoyaltyController::class, 'updateSettings'])->name('settings');
            Route::post('/recalculate',                [CrmLoyaltyController::class, 'recalculate'])->name('recalculate');
